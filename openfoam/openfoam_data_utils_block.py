...
if __name__ == "__main__":
    ...
    for step in [10,200]:
        for res in [50, 100]:
            ...
            root_dir = f'/home/maoy/data/PorousMedia/meltingFoam/DL_workspace/data/regular_runs_time{step}_res{res}/'
            pickle_dir = f'/home/maoy/data/PorousMedia/meltingFoam/DL_workspace/data/regular_pickle_time{step}_res{res}/'
