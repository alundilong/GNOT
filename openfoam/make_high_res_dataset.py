...
if __name__ == "__main__":
    ...
    if case_tag == "long":
        ...
        pickle_dir = '/home/maoy/data/PorousMedia/meltingFoam/DL_workspace/data/pickle_long_test_time10_res50/'
    ...
    loader = openfoam_data_loader(root_dir,dt,duration,rank=device,bc_names=bc_names, max_cases=2)
    
    print(f'total sample: {len(loader.data_all)}')

    dir_to_store = os.path.join(pickle_dir, 'porousmelting_test.pkl') 
